...
public class sunday_day extends javax.swing.JFrame {
    static String[][] sunday_day_array = new String[4][9];
    static int j=0;
    public sunday_day() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Appointment For Sunday  ");
        ...
        exercise_t.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Aquacise", "Box Fit", "Body Blitz" }));
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(id_t, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(name_t, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(mobile_t, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(age_t, javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(exercise_t, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(119, 119, 119)
                                .addComponent(cancel))
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(exercise_t, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
    ...
    // -------- Delete Bookings --------------------------------
    public void set_dlt_7(String vlu)
    {
        boolean jj = false;
        try{
            for(int z1=0;z1<4;z1++)
            {
                if(sunday_day_array[z1][0].equals(vlu))
                {
                    j=z1;
                    sunday_day_array[z1][0]="";
                    sunday_day_array[z1][1]="";
                    sunday_day_array[z1][2]="";
                    sunday_day_array[z1][3]="";
                    sunday_day_array[z1][4]="";
                    sunday_day_array[z1][5]="";
                    sunday_day_array[z1][6]="";
                    sunday_day_array[z1][7]="";
                    jj=true;
                    break;
                }
                else
...
// --------show Bookings --------------------------------
    public void set_7(String vlu1)
    {
        boolean jj = false;
        try{
            for(int z1=0;z1<4;z1++)
            {
                if(sunday_day_array[z1][0].equals(vlu1))
                {
                    JOptionPane.showMessageDialog(this,"ID     : "+this.sunday_day_array[z1][0]+"\n\nName     : "+this.sunday_day_array[z1][1]+"\n\nAge      : "+this.sunday_day_array[(z1)][2]+"\n\nMobile   : "+this.sunday_day_array[(z1)][3]+"\n\nAddress  : "+this.sunday_day_array[z1][4]+"\n\nExercise : "+this.sunday_day_array[z1][5]+"\n\nDay      : "+this.sunday_day_array[z1][6]+"\n\nTiming      : "+this.sunday_day_array[(z1)][7]+"\n\n"+"Fees      : "+this.sunday_day_array[(z1)][8]+"\n\n");
                    jj=true;
                    break;
                }
                else
...
// -------- set Update values --------------------------------
    public void set_update_values_7(String temp[])
    {
        boolean jj = false;
        try{
            for(int z1=0;z1<4;z1++)
            {
                if(sunday_day_array[z1][0].equals(temp[0]))
                {
                    jj=true;
                    this.sunday_day_array[z1][0]=temp[0];
                    this.sunday_day_array[z1][1]=temp[1];
                    this.sunday_day_array[z1][2]=temp[2];
                    this.sunday_day_array[z1][3]=temp[3];
                    this.sunday_day_array[z1][4]=temp[4];
                    this.sunday_day_array[z1][5]=temp[5];
                    this.sunday_day_array[z1][6]=temp[6];
                    this.sunday_day_array[z1][7]=temp[7];
                    break;
                }
                else
                {   
...
// -------- Set Changes --------------------------------
    public void set_change_7(String vlu)
    {
        ...
        try{
            for(int z1=0;z1<4;z1++)
            {
                if(sunday_day_array[z1][0].equals(vlu))
                {
                    jj=true;
                    send[0]=vlu;
                    send[1]=this.sunday_day_array[z1][1];
                    send[2]=this.sunday_day_array[z1][2];
                    send[3]=this.sunday_day_array[z1][3];
                    send[4]=this.sunday_day_array[z1][4];
                    send[5]=this.sunday_day_array[z1][5];
                    send[6]=this.sunday_day_array[z1][6];
                    send[7]=this.sunday_day_array[z1][7];                    
                    Update_record_3 up= new Update_record_3();
                    up.setVisible(true);
                    up.update_values_sunday(send);
                    break;
                }
                else
                {   
                ...
                if(Integer.parseInt(age)>0 && Integer.parseInt(mobile)>0 )
                {
                    if(mobile.length() == 10)
                    {
                        ...
                        if(j<4)
                        {
                            ...
                            if(sunday_day_array[j][4] == null || sunday_day_array[j][4].equals(""))
                            {
                                this.sunday_day_array[j][0]="SU"+String.valueOf(j);
                                this.sunday_day_array[j][1]=name;
                                this.sunday_day_array[j][2]=age;
                                this.sunday_day_array[j][3]=mobile;
                                this.sunday_day_array[j][4]=address;
                                this.sunday_day_array[j][5]=exercise;
                                this.sunday_day_array[j][6]=timing;
                                this.sunday_day_array[j][7]="Sunday";
                                if(exercise == "Aquacise")
                                {
                                    this.sunday_day_array[j][8]="900";
                                }
                                else if(exercise == "Box Fit")
                                {
                                    this.sunday_day_array[j][8]="1000";
                                }
                                else if(exercise == "Body Blitz")
                                {
                                    this.sunday_day_array[j][8]="600";
                                }
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
         this.id_t.setText(String.valueOf("SU"+String.valueOf(j)));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new sunday_day().setVisible(true);
            }
        });
    }
