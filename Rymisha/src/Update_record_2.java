...
public class Update_record_2 extends javax.swing.JFrame {
    public Update_record_2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Saturday Records");
        ...
        exercise_tt2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select", "Yoga", "Zumba" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(time_tt2, 0, 215, Short.MAX_VALUE)
                    .addComponent(exercise_tt2, 0, 215, Short.MAX_VALUE))
                .addGap(51, 51, 51))
            .addGroup(layout.createSequentialGroup()
                .addGap(187, 187, 187)
    ...
    public void update_values_saturday(String send[])
    {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_record_2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_record_2().setVisible(true);
            }
        });
    }
